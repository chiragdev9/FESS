						...
						<div class="row">
							<div class="col-md-10 ">
							   <div class="input-group">
									...
									<div class="form-group is-empty"><input class="form-control" name="email"placeholder="Email..." type="email" pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,4}$"><span class="material-input"></span></div>
								</div>
							</div>
						</div>
						<div class="row">
							<div class="col-md-10">
								...
								<div class="form-group is-empty"><input placeholder="Password..." name="password"class="form-control" type="password"><span class="material-input"></span></div>
								</div>	
							</div>
						</div>
						<hr>
