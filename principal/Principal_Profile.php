...
$res1 = $mysqli->query("SELECT * FROM principal where principal_name='$login_session'");
                        ...
                        <div class="col-md-6 col-md-offset-2">
                            <div class="card">
                                <div class="card-header" data-background-color="royal">
                                    <h4 class="title">Principal Profile</h4>
											...
											<tr>
												<td>
													<div class="input-group">
														...
														<div class="form-group is-empty"><input disabled class="form-control" value="<?php echo $name?>"placeholder="Principal Name..." type="text"><span class="material-input"></span></div>
													</div>
												</td>
											</tr>
                                            <tr>
											<tr>
												<td>
													<div class="input-group">
														...
														<div class="form-group is-empty"><input disabled class="form-control" value="<?php echo $dept ?>" placeholder="abc@xyz.com" type="text"><span class="material-input"></span></div>
													</div>
												</td>
											</tr>
											<tr>
