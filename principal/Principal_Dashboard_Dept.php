...
<body>
    ...
    -->
        ...
        <div class="main-panel">
			...
			<div class="col-md-4">
				<a href="dash.php?dept=Information Technology">
					<div class="card">
						<div class="card-header" data-background-color="royal" >
							<img src="../images/IT_White.png" alt="Principal Login image">	
						</div>
			...
			<div class="col-md-4">
				<a href="dash.php?dept=Computer">
					<div class="card">
						<div class="card-header" data-background-color="royal" >
							<img src="../images/Computer_White.png" alt="Principal Login image">	
						</div>
						<div class="card-content">
			...
			<div class="col-md-4">
				<a href="dash.php?dept=Electronics&comm">
					<div class="card">
						<div class="card-header" data-background-color="royal" >
							<img src="../images/EC_White.png" alt="Principal Login image">	
						</div>
						<div class="card-content">
			...
			<div class="col-md-4">
				<a href="dash.php?dept=Mechanical">
					<div class="card">
						<div class="card-header" data-background-color="royal" >
							<img src="../images/Mechanical_White.png" alt="Principal Login image">	
						</div>
						<div class="card-content">
			...
			<div class="col-md-4">
				<a href="dash.php?dept=Electrical">
					<div class="card">
						<div class="card-header" data-background-color="royal" >
							<img src="../images/Electrical_White.png" alt="Principal Login image">	
						</div>
						<div class="card-content">
			...
			<div class="col-md-4">
				<a href="dash.php?dept=Civil">
					<div class="card">
						<div class="card-header" data-background-color="royal" >
							<img src="../images/Civil_White.png" alt="Principal Login image">	
						</div>
						<div class="card-content"> 
			...
			<div class="col-md-4">
				<a href="dash.php?dept=Science&Humanities">
					<div class="card">
						<div class="card-header" data-background-color="royal" >
							<img src="../images/Science_White.png" alt="Principal Login image">	
						</div>
						<div class="card-content">
