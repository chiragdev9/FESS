						...
						<div class="row">
							<div class="col-md-10 ">
							   <div class="input-group">
									...
									<div class="form-group is-empty"><input class="form-control" name="user"placeholder="Email..." type="text"><span class="material-input"></span></div>
								</div>
							</div>
						</div>
						<div class="row">
